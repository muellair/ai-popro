...
# 2️⃣ Payload: this is the JSON you copied from Firefox (trimmed here)
...
# 3️⃣ Headers (at least content-type and user-agent)
headers = {
...
if response.status_code == 200:
    ...
    print("CSV extracted to ./dataset/")
else:
